...
import { X, Copy, Check, ImageIcon, Trash2, Wand2, Loader2, ArrowRight, RotateCcw, Gamepad2 } from 'lucide-react';
            ...
            <div className="p-md space-y-md">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-md">
                ...
                <div>
                  ...
                  <div className="relative aspect-video radius-md overflow-hidden border border-slate-700 bg-slate-900/50">
                    <Image
                      src={image.url}
